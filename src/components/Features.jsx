...
const BentoTilt =({children, className = ""}) => {
  const [tranformStyle,setTransformStyle] = useState();
...
const BentoCard = ({ src, title, description }) => {
  return (
    <div className="relative size-full">
      ...
      />
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-[#DFDFF0]">
        <div>
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p
            className="text-lg text-[#DFDFF0]"
            style={{ fontFamily: "circular-web, sans-serif" }}
          >
            Into the Metagame Layer
          </p>

          <p
            className="max-w-md  text-lg text-[#DFDFF0] opacity-50"
            style={{ fontFamily: "circular-web, sans-serif" }}
          >
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7" >
          <BentoTilt className="bento-tilt_3 row-span-1 md:col-span-1 md:row-span-2">
          ...
          <BentoTilt className="bento-till_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          ...
          <BentoTilt className="bento-till_1 me-14 md:col-span-1 md:me-0 ">
          ...
          <BentoTilt className="bento-till_2">
